...
export default function AdminLayout() {
  ...
  return (
    ...
    >
      ...
      {/* SIDEBAR / HEADER */}
      <aside 
        className={`flex flex-col sticky top-0 z-50 shrink-0 transition-all duration-300 ease-in-out lg:h-screen lg:border-b-0 shadow-sm lg:shadow-none ${
          ...
          {menuItems.map((item) => (
            <button
              ...
              className={isMobile 
                ...
                : `flex items-center w-full py-3.5 border-none text-[0.9rem] cursor-pointer text-left transition-all duration-300 ease-out lg:rounded-r-xl lg:my-0.5 nav-item-admin ${
